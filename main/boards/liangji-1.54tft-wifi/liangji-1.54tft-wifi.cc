...
#define TAG "LIANGJI_1_54TFT_WIFI"

class LIANGJI_1_54TFT_WIFI : public WifiBoard {
private:
    Button boot_button_;
...
DECLARE_BOARD(LIANGJI_1_54TFT_WIFI);