...
#include "../liangji-1.54tft-wifi/liangji_lcd_display.h"
...
#include "../liangji-1.54tft-wifi/power_manager.h"
...
#define TAG "LIANGJI_1_54TFT_ML307"

class LIANGJI_1_54TFT_ML307 : public DualNetworkBoard {
private:
    Button boot_button_;
    Button volume_up_button_;
    Button volume_down_button_;
    LIANGJI_LcdDisplay* display_;
    ...
    void InitializeSt7789Display() {
        ...
        display_ = new LIANGJI_LcdDisplay(panel_io_, panel_, DISPLAY_WIDTH, DISPLAY_HEIGHT, DISPLAY_OFFSET_X, DISPLAY_OFFSET_Y, 
            DISPLAY_MIRROR_X, DISPLAY_MIRROR_Y, DISPLAY_SWAP_XY);
        display_->SetupHighTempWarningPopup();
    }

public:
    LIANGJI_1_54TFT_ML307() :
...
DECLARE_BOARD(LIANGJI_1_54TFT_ML307);
